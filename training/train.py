...
class FitTrainer:
    ...
    def __init__(self, config_path: str = "../configs/config_fast.yaml"):
        ...
        logger.info(f"FitTrainer 初始化完成，配置文件: {config_path}")
...
def main():
    ...
    try:
        ...
        trainer = FitTrainer(config_path)
        
        # 训练模型
        train_result = trainer.train()

        logger.info("接下来可以使用 Ollama 部署模型: ollama create Fit -f deployment/Modelfile.Fit")
